...
import (
	server "github.com/J-Obog/paidoff/server"
...
func (_m *Server) RegisterRoute(method string, url string, rh server.RouteHandler) {
	_m.Called(method, url, rh)
}

// Start provides a mock function with given fields: port
func (_m *Server) Start(port int) error {
	ret := _m.Called(port)
